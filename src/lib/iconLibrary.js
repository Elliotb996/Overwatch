...
const GLYPHS = {
  ...
  nuclear: c => `
      ${_brackets(c)}
      <circle cx="16" cy="16" r="10" ${_s(c)}/>
      <g ${_sf(c)}>
        <circle cx="16" cy="16" r="1.5" />
        <path d="M17,17.732 L19.5,22.062 A7,7 0 0,1 12.5,22.062 L15,17.732 A2,2 0 0,0 17,17.732 Z" />
        <path d="M17,17.732 L19.5,22.062 A7,7 0 0,1 12.5,22.062 L15,17.732 A2,2 0 0,0 17,17.732 Z" transform="rotate(120 16 16)" />
        <path d="M17,17.732 L19.5,22.062 A7,7 0 0,1 12.5,22.062 L15,17.732 A2,2 0 0,0 17,17.732 Z" transform="rotate(240 16 16)" />
      </g>`,
